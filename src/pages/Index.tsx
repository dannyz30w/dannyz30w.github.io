      ...
      <main className="flex-grow max-w-7xl w-full mx-auto px-4 md:px-6 py-8">
        <section className="mb-10">
          <div className="text-center max-w-2xl mx-auto animate-fade-in">
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent mb-6 transform transition-transform hover:scale-105 duration-300">
              Symptora
            </h1>
